                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="card-title">Danh sách Sản Phẩm Nổi Bật</h5>
                                <div>
                                    <a class="btn btn-success" href="{{route('admin.products.createSellingOrFeatured', 'featured')}}">Thêm Sản Phẩm Nổi Bật</a>
                                </div>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        @foreach($listData as $value)
                                            <div class="row m-0 border-bottom p-2" style="min-width: 1440px; overflow: auto;">
                                                <div class="col-1 d-flex align-items-center justify-content-center p-0 text-center">{{$value->id}}</div>
                                                <div class="col-2">
                                                    <p>{{$value->name}}</p>
                                                ...
                                                <div class="col-1 d-flex justify-content-center align-items-center">
                                                    <div class="btn-group">
                                                        <a href="{{url('admin/products/delete-featured/'.$value->id)}}" class="btn btn-delete btn-icon btn-light btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Xóa">
