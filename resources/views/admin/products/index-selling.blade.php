                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a class="btn btn-success" href="{{route('admin.products.createSellingOrFeatured', 'selling')}}">Thêm Sản Phẩm Bán Chạy</a>
                                </div>
                            </div>
                                        ...
                                        @foreach($listData as $value)
                                            <div class="row m-0 border-bottom p-2" style="min-width: 1440px; overflow: auto;">
                                                ...
                                                <div class="col-1 d-flex justify-content-center align-items-center">
                                                    <div class="btn-group">
                                                        <a href="{{url('admin/products/delete-selling/'.$value->id)}}" class="btn btn-delete btn-icon btn-light btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Xóa">
