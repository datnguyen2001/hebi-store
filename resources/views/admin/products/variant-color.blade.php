<div class="mt-3 border-bottom data-variant pb-3">
    <div class="row m-0">
        ...
        <div class="col-lg-2 p-1">
            <button type="button" class="btn btn-primary btn-add-color form-control"><i class="bi bi-plus-lg"></i>Thêm
                Sản Phẩm
            </button>
        </div>
        <div class="col-lg-2 p-1">
    ...
    <div class="row m-0 pb-1">
        ...
        <div class="form-check form-switch col-lg-2 p-1">
            ...
            <label class="form-check-label" for="flexSwitchCheckChecked" style="margin-top: 9px;margin-left: 8px">Sản
                phẩm nổi bật</label>
        </div>
    </div>
    <div class="card mb-3">
    ...
    <div class="list-size">
        <div class="row m-0">
            <div class="col-lg-3 p-1">
                <input type="text" name="variant[{{$count}}][data][0][color]" class="form-control color"
                       placeholder="Tên loại sản phẩm" required>
            </div>
            <div class="col-lg-3 p-1">
                <input name="variant[{{$count}}][data][0][price]" type="text" class="form-control price format-currency"
                       placeholder="Gía gốc">
            </div>
            <div class="col-lg-3 p-1">
                <input name="variant[{{$count}}][data][0][promotion_price]" type="text"
                       class="form-control promotion_price format-currency" placeholder="Gía bán">
            </div>
        </div>
    </div>
</div>
