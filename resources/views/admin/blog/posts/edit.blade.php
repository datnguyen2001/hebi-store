                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{url("admin/blog/blog_posts/update",$blog->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-3">
                                        ...
                                        @if(count($category))
                                            <select name="blogCategory_id" class="form-select">
                                                ...
                                                @foreach($category as $value)
                                                    <option @if($blog->blog_category_id == $value->id) selected @endif value="{{$value->id}}">{{$value->name}}</option>
                                                @endforeach
                                            </select>
                                        @else
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control" name="link" type="text" value="{{$blog->link}}" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-8">
                                        <div class="form-control position-relative div-parent" style="padding-top: 50%">
                                            <div class="position-absolute w-100 h-100 div-file" style="top: 0; left: 0;z-index: 10">
                                                ...
                                                @if($blog->is_video == 0)
                                                    <img src="{{$blog->src}}" class="w-100 h-100" style="object-fit: cover">
                                                @else
                                                    <video class="w-100 h-100" style="object-fit: cover" controls>
                                                        <source src="{{$blog->src}}"></video>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-5">
                                    <div class="col-12 d-flex justify-content-center">
                                        <a href="{{route('admin.blog.blog_posts.index')}}" class="btn btn-danger" style="margin-right: 20px">Hủy</a>
