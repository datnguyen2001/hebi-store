                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-select" name="type"
                                            ...
                                            <option class="bg-info" value="3">Laptop</option>
                                            <option class="bg-info" value="4">Đồng hồ thông minh</option>
                                            <option class="bg-info" value="5">Nhà thông minh</option>
                                            <option class="bg-info" value="6">Phụ kiện</option>
                                            <option class="bg-info" value="7">Âm thanh</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-3">
